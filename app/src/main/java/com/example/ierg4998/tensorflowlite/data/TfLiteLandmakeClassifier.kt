package com.example.ierg4998.tensorflowlite.data
...
class TfLiteLandmakeClassifier(
    ...
    private fun setupClassifier(){
        ...
        try {
            //can use by different tflite model
    ...
    override fun classify(bitmap: Bitmap, rotation: Int): List<Classification> {
        ...
        return results?.flatMap { classications ->
            classications.categories.map { category ->
                Log.d("Classification", "Category: ${category.displayName}, Score: ${category.score}")
                Classification(
